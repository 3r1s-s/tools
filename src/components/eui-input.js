class EUIInput extends HTMLElement {
    static get observedAttributes() {
        return ["label", "value", "id", "type", "filled", "readonly"];
    }
        ...
        this.shadowRoot.innerHTML = `
            <style>
                ...
                .form-input {
                    ...
                    font-family: inherit;
                    height: 52px;
                    background: var(--app-100, #ffffffff);
                    outline: none;
                    border: 1px solid var(--app-accent, #2196F3);
                ...
                .filled.form .form-input:focus {
                    border-bottom: 2.5px solid var(--app-accent, #2196F3);
                }
    ...
    connectedCallback() {
        ...
        if (this.hasAttribute('readonly')) this.inputEl.readOnly = true;
